...
internal class CSharpCodeStyles
{
    ...
    public string GetStyleForTypeSymbol(ITypeSymbol typeSymbol)
    {
        ...
        return typeSymbol.TypeKind switch
        {
            ...
            TypeKind.Interface => TypeInterface,
            TypeKind.Struct => TypeStruct,
            TypeKind.TypeParameter => TypeGeneric,
            TypeKind.Delegate or TypeKind.Class or TypeKind.Dynamic => TypeClass,
            _ => throw new InvalidOperationException($"Unrecognised type kind {typeSymbol.TypeKind}."),
        };
    }
