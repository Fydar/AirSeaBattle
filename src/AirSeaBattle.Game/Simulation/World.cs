...
public class World
{
    ...
    /// </summary>
    public EventDictionary<Guid, WorldEnemy> Enemies { get; } = [];

    /// <summary>
    /// All <see cref="WorldPlayer"/> currently contributing to the game world.
    /// </summary>
    public EventDictionary<Guid, WorldPlayer> Players { get; } = [];

    /// <summary>
    /// All <see cref="WorldGun"/> in the game world.
    /// </summary>
    public EventDictionary<Guid, WorldGun> Guns { get; } = [];

    /// <summary>
    /// All <see cref="WorldProjectile"/> in the game world.
    /// </summary>
    public EventDictionary<Guid, WorldProjectile> Projectiles { get; } = [];
